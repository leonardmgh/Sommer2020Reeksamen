...
namespace Dentist.Controllers
{
    ...
    public class BillableItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Description,FirstName,InsurancePart")] BillableItems billableItems)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Description,FirstName,InsurancePart")] BillableItems billableItems)
        {
