...
namespace DentistBilling.Migrations
{
    ...
    [Migration("20210809214443_InitialCreate")]
            ...
            modelBuilder.Entity("DentistBilling.Models.Bill", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            BillDate = new DateTimeOffset(new DateTime(2021, 8, 9, 23, 44, 43, 234, DateTimeKind.Unspecified).AddTicks(4767), new TimeSpan(0, 2, 0, 0, 0)),
                            CostumerID = 1,
                            TotalCostumer = 310.5,
                            TotalInsureance = 0.0
                        },
                        ...
                        {
                            ID = 2,
                            BillDate = new DateTimeOffset(new DateTime(2021, 8, 9, 23, 44, 43, 236, DateTimeKind.Unspecified).AddTicks(164), new TimeSpan(0, 2, 0, 0, 0)),
                            CostumerID = 1,
                            TotalCostumer = 310.5,
                            TotalInsureance = 0.0
                        },
                        ...
                        {
                            ID = 3,
                            BillDate = new DateTimeOffset(new DateTime(2021, 8, 9, 23, 44, 43, 236, DateTimeKind.Unspecified).AddTicks(192), new TimeSpan(0, 2, 0, 0, 0)),
                            CostumerID = 2,
                            TotalCostumer = 110.5,
